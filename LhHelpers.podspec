...
Pod::Spec.new do |s|
  ...
  s.author             = { "Chase Burnham" => "cburnhamiv@gmail.com" }
  # Or just: s.author    = "Chase Burnham"
  # s.authors            = { "Chase Burnham" => "cburnhamiv@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Chase Burnham"
